...
def main():
    ...
    while not done:
        ...
        for step in range(300):
            ...
            np.savetxt(f"./exp_per_step/perturb_v2/raw_reward_{b_loop}_{step}.txt", return_list, delimiter=",")
        ...
        np.savetxt("./exp_per_step/perturb_v2/Confidence_Lowerbound_Record.txt", result_rec, delimiter=",")
        np.savetxt("./exp_per_step/perturb_v2/Epoch_Record.txt", epoch_record, delimiter=",")
    ...
    np.savetxt("./exp_per_step/perturb_v2/Confidence_Lowerbound_Record.txt", result_rec, delimiter=",")
    np.savetxt("./exp_per_step/perturb_v2/Epoch_Record.txt", epoch_record, delimiter=",")
    torch.save(behavior_pi.state_dict(), "./exp_per_step/perturb_v2/Optimized_Behavioural_model.pth")
