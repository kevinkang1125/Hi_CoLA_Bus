...
def main():
    ...
    while not done:
        ...
        np.savetxt("./exp_multi_epochs/dynamic_bounds/Confidence_Lowerbound_Record.txt", result_rec, delimiter=",")
        #save all confidence lower bound per epoch
        np.savetxt("./exp_multi_epochs/dynamic_bounds/Epoch_Record.txt", epoch_record, delimiter=",")
        # record the length of each epoch
        np.savetxt("./exp_multi_epochs/dynamic_bounds/Epoch_Length_Record.txt", step_rec, delimiter=",")
    ...
    # record the length of each epoch
    np.savetxt("./exp_multi_epochs/dynamic_bounds/Epoch_Length_Record.txt", step_rec, delimiter=",")
    torch.save(behavior_pi.state_dict(), "./exp_multi_epochs/dynamic_bounds/Optimized_Behavioural_model.pth")
